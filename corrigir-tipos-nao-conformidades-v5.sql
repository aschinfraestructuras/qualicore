-- =====================================================
-- CORRIGIR TIPOS DE DADOS EM NÃO CONFORMIDADES - VERSÃO 5
-- =====================================================
...
-- 2. REMOVER TODOS OS VALORES PADRÃO DE FORMA SEGURA
-- =====================================================

-- Remover valores padrão das colunas de forma segura
DO $$
BEGIN
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Valor padrão removido de anexos_evidencia';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Valor padrão removido de anexos_corretiva';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Valor padrão removido de anexos_verificacao';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Valor padrão removido de anexos';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Valor padrão removido de documents';
    END IF;
END $$;
...
-- 5. ADICIONAR VALORES PADRÃO CORRETOS (APENAS APÓS CONVERSÃO)
-- =====================================================

-- Adicionar valores padrão corretos para JSONB
DO $$
BEGIN
    -- Verificar se as colunas são JSONB antes de definir valores padrão
    IF EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_name = 'nao_conformidades' 
        AND column_name = 'anexos_evidencia' 
        ...
        RAISE NOTICE 'Valor padrão definido para anexos_evidencia';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Valor padrão definido para anexos_corretiva';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Valor padrão definido para anexos_verificacao';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Valor padrão definido para anexos';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Valor padrão definido para documents';
    END IF;
END $$;
