-- =====================================================
-- FORÇAR CONVERSÃO - NÃO CONFORMIDADES
-- =====================================================
-- Execute este script no SQL Editor do Supabase
-- Este script força a conversão dos campos de text[] para JSONB
...
-- 2. FORÇAR CONVERSÃO DOS CAMPOS
-- =====================================================

-- Forçar conversão de anexos_evidencia
DO $$
BEGIN
...
-- Forçar conversão de anexos_corretiva
DO $$
BEGIN
    -- Remover valor padrão se existir
    BEGIN
...
-- Forçar conversão de anexos_verificacao
DO $$
BEGIN
    -- Remover valor padrão se existir
    BEGIN
