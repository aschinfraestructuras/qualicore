...
export const localEnsaiosAPI = {
  ...
  create: async (newEnsaio: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedEnsaios = addToLocalCollection(
      "ensaios",
      data.ensaios,
      newEnsaio,
    );
  ...
  update: async (id: string, updates: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedEnsaios = updateLocalCollection(
      "ensaios",
      data.ensaios,
      id,
      updates,
  ...
  delete: async (id: string): Promise<boolean> => {
    const data = getLocalData();
    const updatedEnsaios = removeFromLocalCollection(
      "ensaios",
      data.ensaios,
      id,
    );
...
export const localDocumentosAPI = {
  ...
  create: async (newDocumento: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedDocumentos = addToLocalCollection(
      "documentos",
      data.documentos,
      newDocumento,
    );
  ...
  update: async (id: string, updates: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedDocumentos = updateLocalCollection(
      "documentos",
      data.documentos,
      id,
      updates,
  ...
  delete: async (id: string): Promise<boolean> => {
    const data = getLocalData();
    const updatedDocumentos = removeFromLocalCollection(
      "documentos",
      data.documentos,
      id,
    );
...
export const localChecklistsAPI = {
  ...
  create: async (newChecklist: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedChecklists = addToLocalCollection(
      "checklists",
      data.checklists,
      newChecklist,
    );
  ...
  update: async (id: string, updates: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedChecklists = updateLocalCollection(
      "checklists",
      data.checklists,
      id,
      updates,
  ...
  delete: async (id: string): Promise<boolean> => {
    const data = getLocalData();
    const updatedChecklists = removeFromLocalCollection(
      "checklists",
      data.checklists,
      id,
    );
...
export const localMateriaisAPI = {
  ...
  create: async (newMaterial: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedMateriais = addToLocalCollection(
      "materiais",
      data.materiais,
      newMaterial,
    );
  ...
  update: async (id: string, updates: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedMateriais = updateLocalCollection(
      "materiais",
      data.materiais,
      id,
      updates,
  ...
  delete: async (id: string): Promise<boolean> => {
    const data = getLocalData();
    const updatedMateriais = removeFromLocalCollection(
      "materiais",
      data.materiais,
      id,
    );
...
export const localFornecedoresAPI = {
  ...
  create: async (newFornecedor: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedFornecedores = addToLocalCollection(
      "fornecedores",
      data.fornecedores,
      newFornecedor,
    );
  ...
  update: async (id: string, updates: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedFornecedores = updateLocalCollection(
      "fornecedores",
      data.fornecedores,
      id,
      updates,
  ...
  delete: async (id: string): Promise<boolean> => {
    const data = getLocalData();
    const updatedFornecedores = removeFromLocalCollection(
      "fornecedores",
      data.fornecedores,
      id,
    );
...
export const localNaoConformidadesAPI = {
  ...
  create: async (newNaoConformidade: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedNaoConformidades = addToLocalCollection(
      "nao_conformidades",
      data.nao_conformidades,
      newNaoConformidade,
    );
  ...
  update: async (id: string, updates: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedNaoConformidades = updateLocalCollection(
      "nao_conformidades",
      data.nao_conformidades,
      id,
      updates,
  ...
  delete: async (id: string): Promise<boolean> => {
    const data = getLocalData();
    const updatedNaoConformidades = removeFromLocalCollection(
      "nao_conformidades",
      data.nao_conformidades,
      id,
    );
...
export const localObrasAPI = {
  ...
  update: async (id: string, updates: any): Promise<any | null> => {
    const data = getLocalData();
    const updatedObras = updateLocalCollection(
      "obras",
      data.obras,
      id,
      updates,
