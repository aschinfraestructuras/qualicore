...
export const ShareMaterialModal: React.FC<ShareMaterialModalProps> = ({
  isOpen,
  onClose,
  material
}) => {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      const results = await shareService.shareMaterial(material, options);
      setResults(results);
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gray-50 p-4 rounded-lg mb-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div><span className="font-medium">Nome:</span> {material.nome}</div>
            ...
            <div><span className="font-medium">Zona:</span> {material.zona}</div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder={`Material ${material.nome}`}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
