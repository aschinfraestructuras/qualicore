      ...
      await pb.collections.create({
        ...
        schema: [
          ...
          { name: "tipo", type: "text", required: true },
          {
            name: "material_id",
            type: "relation",
            options: { collectionId: "materiais" },
          },
          ...
          { name: "zona", type: "text" },
          {
            name: "estado",
            type: "select",
            options: { values: ["pendente", "aprovado", "reprovado"] },
          },
      ...
      await pb.collections.create({
        ...
        schema: [
          { name: "titulo", type: "text", required: true },
          {
            ...
            type: "select",
            options: {
              values: ["projeto", "especificacao", "relatorio", "outro"],
            },
          },
          ...
          { name: "responsavel", type: "text" },
          {
            ...
            type: "select",
            options: {
              values: ["rascunho", "revisao", "aprovado", "obsoleto"],
            },
          },
      ...
      await pb.collections.create({
        ...
        schema: [
          ...
          { name: "solicitante", type: "text", required: true },
          {
            name: "prioridade",
            type: "select",
            options: { values: ["baixa", "media", "alta", "urgente"] },
          },
          {
            name: "estado",
            type: "select",
            options: {
              values: ["pendente", "em_analise", "respondido", "fechado"],
            },
          },
          {
            name: "impacto_custo",
            type: "select",
            options: { values: ["nenhum", "baixo", "medio", "alto"] },
          },
          {
            name: "impacto_prazo",
            type: "select",
    ...
    const outrasColecoes = [
      {
        ...
        schema: [
          { name: "titulo", type: "text", required: true },
          {
            name: "tipo",
            type: "select",
            options: { values: ["seguranca", "qualidade", "producao"] },
          },
          { name: "itens", type: "json" },
          {
            name: "estado",
            type: "select",
            options: { values: ["pendente", "em_progresso", "concluido"] },
          },
        ],
      },
      {
        ...
        schema: [
          ...
          { name: "especificacoes", type: "editor" },
          {
            name: "fornecedor_id",
            type: "relation",
            options: { collectionId: "fornecedores" },
          },
        ],
      },
      {
      ...
      },
      {
        ...
        schema: [
          ...
          },
          {
            ...
            type: "select",
            options: {
              values: ["aberta", "em_analise", "resolvida", "fechada"],
            },
          },
