-- =====================================================
-- SCRIPT SQL COMPLETO - SISTEMA DE CERTIFICADOS E REGISTOS
-- =====================================================
...
-- Inserir dados de exemplo para certificados
...
(
    'CERT-002', 'Certificado Ambiental ISO 14001:2015',
    'Certificação do Sistema de Gestão Ambiental conforme norma ISO 14001:2015',
    'ambiente', 'sistema_gestao', 'Gestão Ambiental em todas as atividades',
    'SGS Portugal', '2024-03-20', '2027-03-20', 'ativo', 'valido',
    uuid_generate_v4(), 'Maria Santos', 'maria.santos@empresa.pt',
    (SELECT id FROM auth.users LIMIT 1)
),
(
    'CERT-003', 'Certificado de Segurança OHSAS 18001',
    'Certificação do Sistema de Gestão de Segurança e Saúde no Trabalho',
    'seguranca', 'sistema_gestao', 'Segurança e Saúde no Trabalho',
    'TÜV Rheinland', '2023-11-10', '2026-11-10', 'ativo', 'valido',
    uuid_generate_v4(), 'Pedro Costa', 'pedro.costa@empresa.pt',
    (SELECT id FROM auth.users LIMIT 1)
);

-- Inserir dados de exemplo para registos
...
(
    'REG-002', 'Inspeção de Equipamentos de Segurança',
    'Inspeção mensal dos equipamentos de proteção individual',
    'inspecao', 'seguranca', '2024-12-20', 'em_andamento', 'media',
    uuid_generate_v4(), 'Carlos Ferreira', 'carlos.ferreira@empresa.pt',
    (SELECT id FROM auth.users LIMIT 1)
);

-- Inserir dados de exemplo para termos
...
-- Inserir dados de exemplo para cabeçalhos
