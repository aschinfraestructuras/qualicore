...
export const obrasAPI = {
  ...
  create: async (obra: Omit<InsertDto<'obras'>, 'user_id'>): Promise<Obra | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('obras')
  ...
  update: async (id: string, obra: UpdateDto<'obras'>): Promise<Obra | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('obras')
...
export const fornecedoresAPI = {
  ...
  create: async (fornecedor: Omit<InsertDto<'fornecedores'>, 'user_id'>): Promise<Fornecedor | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('fornecedores')
  ...
  update: async (id: string, fornecedor: UpdateDto<'fornecedores'>): Promise<Fornecedor | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('fornecedores')
...
export const materiaisAPI = {
  ...
  create: async (material: Omit<InsertDto<'materiais'>, 'user_id'>): Promise<Material | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('materiais')
  ...
  update: async (id: string, material: UpdateDto<'materiais'>): Promise<Material | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('materiais')
...
export const ensaiosAPI = {
  ...
  create: async (ensaio: Omit<InsertDto<'ensaios'>, 'user_id'>): Promise<Ensaio | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('ensaios')
  ...
  update: async (id: string, ensaio: UpdateDto<'ensaios'>): Promise<Ensaio | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('ensaios')
...
export const checklistsAPI = {
  ...
  create: async (checklist: Omit<InsertDto<'checklists'>, 'user_id'>): Promise<Checklist | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('checklists')
  ...
  createWithPontos: async (checklist: any, pontos: any[]): Promise<Checklist | null> => {
    try {
      const user = await getCurrentUser()
      
      // Filtrar apenas campos válidos do checklist
      const validChecklistFields = [
        'codigo', 'obra_id', 'titulo', 'status', 'responsavel', 'zona', 'estado', 'observacoes'
      ]
      ...
      if (pontos && pontos.length > 0) {
        const pontosData = pontos.map(ponto => ({
          ...
          data_inspecao: ponto.data_inspecao && ponto.data_inspecao !== '' ? ponto.data_inspecao : null,
  ...
  update: async (id: string, checklist: UpdateDto<'checklists'>): Promise<Checklist | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('checklists')
  ...
  updateWithPontos: async (id: string, checklist: any, pontos: any[]): Promise<Checklist | null> => {
    try {
      const user = await getCurrentUser()
...
export const documentosAPI = {
  ...
  create: async (documento: Omit<InsertDto<'documentos'>, 'user_id'>): Promise<Documento | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('documentos')
  ...
  update: async (id: string, documento: UpdateDto<'documentos'>): Promise<Documento | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('documentos')
...
export const naoConformidadesAPI = {
  ...
  create: async (nc: Omit<InsertDto<'nao_conformidades'>, 'user_id'>): Promise<NaoConformidade | null> => {
    try {
      const user = await getCurrentUser()
      
      // Filtrar apenas campos válidos da tabela nao_conformidades
      const validFields = [
        'codigo', 'tipo', 'tipo_outro', 'severidade', 'categoria', 'categoria_outro',
        'data_deteccao', 'data_resolucao', 'data_limite_resolucao', 'data_verificacao_eficacia',
        'descricao', 'causa_raiz', 'impacto', 'area_afetada', 'responsavel_deteccao',
        'responsavel_resolucao', 'responsavel_verificacao', 'acao_corretiva', 'acao_preventiva',
        'medidas_implementadas', 'custo_estimado', 'custo_real', 'custo_preventivo',
        'observacoes', 'relacionado_ensaio_id', 'relacionado_ensaio_outro',
        'relacionado_material_id', 'relacionado_material_outro', 'relacionado_checklist_id',
        'relacionado_checklist_outro', 'relacionado_documento_id', 'relacionado_fornecedor_id',
        'relacionado_fornecedor_outro', 'relacionado_obra_id', 'relacionado_obra_outro',
        'relacionado_zona_id', 'relacionado_zona_outro', 'auditoria_id', 'auditoria_outro'
      ]
  ...
  update: async (id: string, nc: UpdateDto<'nao_conformidades'>): Promise<NaoConformidade | null> => {
    try {
      const user = await getCurrentUser()
...
export const rfisAPI = {
  ...
  create: async (rfi: Omit<InsertDto<'rfis'>, 'user_id'>): Promise<RFI | null> => {
    try {
      const user = await getCurrentUser()
      const { data, error } = await supabase
        .from('rfis')
