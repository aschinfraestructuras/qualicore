    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-100 via-blue-200 to-blue-400 relative overflow-hidden">
      ...
      >
        <div className="flex items-center space-x-4 mb-6">
          ...
          <span className="text-4xl font-extrabold text-blue-900 font-display tracking-wide drop-shadow-lg">
            Qualicore
          </span>
        </div>
        <h2 className="text-2xl md:text-3xl font-bold text-blue-800 mb-2 text-center">
          Gestão da Qualidade para Construção Civil
        </h2>
        <p className="text-lg text-blue-700 mb-8 text-center max-w-xl">
          Modernize o controlo de qualidade da sua obra com tecnologia de ponta,
          formulários inteligentes e dashboards em tempo real.
        </p>
