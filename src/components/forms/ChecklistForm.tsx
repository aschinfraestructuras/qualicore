...
import { Plus, X, Upload, File, Download, Trash2, CheckCircle, AlertCircle, Clock } from 'lucide-react'
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Código do Checklist</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Título do Checklist *</label>
          <input
            type="text"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Zona/Área *</label>
          <input
            type="text"
            value={formData.zona}
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <label className="block text-sm font-medium text-gray-700">Pontos de Inspeção</label>
          <button
            type="button"
            onClick={addPonto}
            ...
            <div key={ponto.id} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <span className="text-sm font-medium text-gray-900">Ponto {idx + 1}</span>
                  <span className={`px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1 ${getStatusColor(ponto.status)}`}>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={e => updatePonto(idx, 'observacoes', e.target.value)}
                  rows={2}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-xs font-medium text-gray-700">Anexos</label>
                  <input
                    type="file"
                ...
                {(ponto.anexos || []).length > 0 && (
                  <div className="space-y-1">
                    {(ponto.anexos || []).map(anexo => (
                      <div key={anexo.id} className="flex items-center justify-between p-2 bg-white rounded border">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-xs font-medium text-gray-700">Comentários</label>
                </div>
                
                {(ponto.comentarios || []).length > 0 && (
                  <div className="space-y-2 mb-2">
                    {(ponto.comentarios || []).map(comentario => (
                      <div key={comentario.id} className="p-2 bg-blue-50 rounded border">
