        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t">
            <div>
              ...
              <p className="text-sm text-gray-900">
                {new Date(material.data_criacao).toLocaleDateString("pt-PT")} às{" "}
                {new Date(material.data_criacao).toLocaleTimeString("pt-PT")}
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500">Atualizado em</p>
              <p className="text-sm text-gray-900">
                {new Date(material.data_atualizacao).toLocaleDateString("pt-PT")} às{" "}
                {new Date(material.data_atualizacao).toLocaleTimeString("pt-PT")}
              </p>
            </div>
          </div>
        </div>
